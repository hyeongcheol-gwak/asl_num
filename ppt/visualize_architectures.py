...
def visualize_boosting(model_name, description, filename):
    ...
    ax.text(
        50,
        77,
        f"Gradient Boosting Framework ({description})",
        ha="center",
        fontsize=11,
        fontweight="bold",
        color="#2c3e50",
